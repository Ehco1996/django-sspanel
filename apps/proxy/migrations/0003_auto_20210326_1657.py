            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        help_text="代理节点",
                        limit_choices_to={"node_type": "ray"},
                ...
                (
                    "config",
                    models.JSONField(
                        default=apps.utils.get_default_ray_config, verbose_name="配置"
                    ),
                ),
            ],
            options={
