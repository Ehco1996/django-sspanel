# Generated by Django 2.0 on 2018-04-09 21:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, default=apps.sspanel.tools.get_long_random_string, max_length=40, primary_key=True, serialize=False, verbose_name='邀请码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(auto_now_add=True, verbose_name='捐赠时间')),
                ('code', models.CharField(blank=True, default=apps.sspanel.tools.get_long_random_string, max_length=40, unique=True, verbose_name='充值码')),
        ...
        migrations.AddField(
            ...
            name='info',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sspanel.Shop'),
        ),
    ]
